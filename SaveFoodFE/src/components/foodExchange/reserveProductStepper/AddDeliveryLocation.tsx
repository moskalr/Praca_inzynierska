...
const translation = "Tabs.AllProducts.ReservationStepper.DetailsDeliveryStep.";

interface CreateMapAddressProps {
  createdMapAddress: CreateMapAddressType;
  handleNext: () => void;
  handleBack: () => void;
  handleUpdateMapAddressDelivery: (
  ...
  const onSubmit = async (data: CreateMapAddressType) => {
    ...
    if (
      ...
      if (
        ...
        snackbarTranslated(t(translation + "Address.notFound"), "error");
      }
    }
  };
